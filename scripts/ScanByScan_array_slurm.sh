...
conda run -n py310 python -u /cmnfs/proj/ORIGINS/protMSD/maxquant/ScanByScan/scripts/sbs_runner.py -ml $mzML -MQ $maxquant -RT_tol $RT_tol -cond $method -alpha $alpha
